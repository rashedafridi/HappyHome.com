<div class="box">
    ...
    <div class="d-flex justify-content-center ">
        <div class="row">
            <div class="col ">
                ...
                <div align="center">
                    <a class="align-items-center btn btn-outline-warning " href="order.php?c_id=<?php echo $customer_id; ?>"> Cash on delivery</a>
    ...
    <input type="image" name="submit" width="500" height="270" src="">
