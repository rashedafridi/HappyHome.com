...
<input type="text" name="coupon_title" class="form-control rounded" value="<?php echo $c_title; ?>" >
...
<input type="text" name="coupon_price" class="form-control rounded" value="<?php echo $c_price; ?>">
...
<input type="text" name="coupon_code" class="form-control rounded" value="<?php echo $c_code; ?> ">
...
<input type="number" name="coupon_limit" value="<?php echo $c_limit; ?>" class="form-control rounded">
...
<select name="product_id" class="form-control rounded">
...
<input type="submit" name="update" class=" btn btn-warning form-control rounded" value=" Update Coupon ">
