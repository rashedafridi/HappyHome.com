...
<input type="text" name="store_title" class="form-control rounded" value="<?php echo $store_title; ?>">
...
<input type="file" name="store_image" class="form-control rounded">
...
<textarea name="store_desc" class="form-control rounded" rows="10" cols="19">
...
<input type="text" name="store_button" class="form-control rounded" value="<?php echo $store_button; ?>">
...
<input type="url" name="store_url" class="form-control rounded" value="<?php echo $store_url; ?>">
...
<input type="submit" name="update" value="Update store" class="btn btn-warning rounded form-control">
