...
<input type="text" name="contact_email" class="form-control rounded" value="<?php echo $contact_email; ?>">
...
<input type="text" name="contact_heading" class="form-control rounded" value="<?php echo $contact_heading; ?>">
...
<textarea name="contact_desc" class="form-control rounded" rows="6" cols="19">
...
<input type="submit" name="submit" class="btn btn-warning form-control rounded" value=" Update Contact Us ">
