...
<input type="text" name="p_cat_title" class="form-control rounded" value="<?php echo $p_cat_title; ?>" >
...
<input type="file" name="p_cat_image" class="form-control rounded" >
...
<input type="submit" name="update" value="Update Now" class="btn btn-Warning form-control" >
