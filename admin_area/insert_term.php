...
<input type="text" name="term_title" class="form-control rounded" >
...
<textarea name="term_desc" class="form-control rounded" rows="6" cols="19" ></textarea>
...
<input type="text" name="term_link" class="form-control rounded" >
...
<input type="submit" name="submit" value="Insert Term" class="btn btn-warning rounded form-control" >
