...
<input type="text" name="cat_title" class="form-control rounded" value="<?php echo $c_title; ?>">
...
<input type="file" name="cat_image" class="form-control rounded">
...
<input type="submit" name="update" value="Update Category" class="btn btn-warning rounded form-control">
