...
<input type="text" name="term_title" class="form-control rounded" value="<?php echo $term_title; ?>">
...
<textarea name="term_desc" class="form-control rounded" rows="6" cols="19" >
<?php echo $term_desc; ?>
</textarea>
...
<input type="text" name="term_link" class="form-control rounded" value="<?php echo $term_link; ?>">
...
<input type="submit" name="update" value="Update Term" class="btn btn-warning rounded form-control" >
