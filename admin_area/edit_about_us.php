...
<input type="text" name="about_heading" class="form-control rounded" value="<?php echo $about_heading; ?>">
...
<textarea name="about_short_desc" class="form-control rounded" rows="5">
...
<textarea name="about_desc" id="about_desc" class="form-control rounded" rows="10">
...
<input type="submit" name="submit" value="Update About Us Page" class="btn btn-warning rounded form-control">
