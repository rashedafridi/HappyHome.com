...
<input type="text" name="store_title" class="form-control rounded">
...
<input type="text" name="store_button" class="form-control rounded">
...
<input type="url" name="store_url" class="form-control rounded">
...
<input type="submit" name="submit" value="Insert store" class="btn btn-warning form-control">
