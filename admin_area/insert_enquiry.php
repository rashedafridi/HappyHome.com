...
<input type="text" name="enquiry_title" class="form-control rounded">
...
<input type="submit" name="submit" class="btn btn-warning form-control rounded" value="Insert Enquiry Type">
