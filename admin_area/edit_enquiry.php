...
<input type="text" name="enquiry_title" class="form-control rounded" value="<?php echo $enquiry_title; ?>">
...
<input type="submit" name="update" class="btn btn-warning form-control rounded" value="Update Enquiry Type">
