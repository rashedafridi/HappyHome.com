...
<input type="text" name="rel_title" class="form-control rounded" value="<?php echo $r_title; ?>">
...
<select name="bundle_id" class="form-control rounded">
...
<input type="submit" name="update" class="btn btn-warning rounded form-control" value="Update Relation">
