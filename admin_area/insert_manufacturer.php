...
<input type="text" name="manufacturer_name" class="form-control rounded" >
...
<input type="radio" name="manufacturer_top rounded" value="yes" >

<label> Yes </label>

<input type="radio" name="manufacturer_top  rounded" value="no" >
...
<input type="submit" name="submit" class="form-control btn btn-warning" value=" Insert Manufacturer " >
