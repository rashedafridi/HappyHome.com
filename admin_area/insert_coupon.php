...
<input type="text" name="coupon_title" class="form-control rounded">
...
<input type="text" name="coupon_price" class="form-control rounded">
...
<input type="text" name="coupon_code" class="form-control rounded">
...
<input type="number" name="coupon_limit" value="1" class="form-control rounded">
...
<input type="submit" name="submit" class=" btn btn-warning rounded form-control" value=" Insert Coupon ">
