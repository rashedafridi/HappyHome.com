...
<label class="col-md-3 control-label" > Bundle nickname </label>
...
<select class="form-control rounded" name="manufacturer"><!-- select manufacturer Starts -->
...
<input type="submit" name="submit" value="Insert Bundle" class="btn btn-warning form-control rounded" >
