...
<div class="panel bg_title"><!-- panel panel-default Starts -->

<div class="panel-heading bg_title"><!-- panel-heading Starts -->
...
<div class="panel-body bg_orange"><!-- panel-body Starts -->
...
<input type="text" name="product_title" class="form-control rounded" required value="<?php echo $p_title; ?>">
...
<input type="text" name="product_url" class="form-control rounded" required value="<?php echo $p_url; ?>" >
...
<select name="manufacturer" class="form-control rounded">
...
<select name="product_cat" class="form-control rounded" >
...
<select name="cat" class="form-control rounded" >
...
<input type="file" name="product_img1" class="form-control rounded" >
...
<input type="file" name="product_img2" class="form-control rounded" >
...
<input type="file" name="product_img3" class="form-control rounded" >
...
<input type="text" name="product_price" class="form-control rounded" required value="<?php echo $p_price; ?>" >
...
<input type="text" name="psp_price" class="form-control rounded" required value="<?php echo $psp_price; ?>">
...
<input type="text" name="product_keywords" class="form-control rounded" required value="<?php echo $p_keywords; ?>" >
...
<textarea name="product_desc" class="form-control rounded" rows="15" id="product_desc">
...
<textarea name="product_features" class="form-control rounded" rows="15" id="product_features">
...
<textarea name="product_video" class="form-control rounded" rows="15">
...
<input type="text" name="product_label" class="form-control rounded" required value="<?php echo $p_label; ?>">
...
<input type="submit" name="update" value="Update Product " class="btn btn-warning  rounded form-control" >
