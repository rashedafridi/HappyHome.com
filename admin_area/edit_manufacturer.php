...
<input type="text" name="manufacturer_name" class="form-control rounded" value="<?php echo $m_title; ?>">
...
<input type="file" name="manufacturer_image" class="form-control rounded" >
...
<input type="submit" name="update" class="form-control btn btn-warning rounded" value=" Update Manufacturer " >
